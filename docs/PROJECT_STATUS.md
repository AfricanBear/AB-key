...
- Release tags `v0.1.0` through `v0.5.0` created and pushed.
...
### Index toolbar hotkeys (v0.5.0)

- `toolbarIndex` locator for Alt+1–5 on Abacum side rail; aria fallback for 1–4.
